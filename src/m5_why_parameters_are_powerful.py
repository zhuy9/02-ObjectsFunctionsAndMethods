...
def main():
    ...
    # better_draw_circles(rg.Point(200, -200), 10)  # delta radius  = 10
    # better_draw_circles(rg.Point(100, 50), 15)  # delta radius  = 15
    # better_draw_circles(rg.Point(-200, 0), 20)  # delta radius  = 5
    # even_better_draw_circles(rg.Point(0,-100),15,15,"blue",10)
    # even_better_draw_circles(rg.Point(0,100),8,28,"blue",3)
    # even_better_draw_circles(rg.Point(100,0), 10, 15, "red", 5)
    # even_better_draw_circles(rg.Point(-100, 0), 8, 28, "red", 3)
    draw_circles(rg.Point(-90, 0))
    better_draw_circles(rg.Point(200, 50), 15)
    even_better_draw_circles(rg.Point(0, 100), 8, 28, "blue", 3)
    even_better_draw_circles(rg.Point(100,0), 10, 15, "red", 5)
    even_better_draw_circles(rg.Point(-100, 0), 8, 28, "red", 3)
    window.update()
...
def better_draw_circles(point, radiusIncrease):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN desired number of pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(radiusIncrease)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(radiusIncrease * k)
...
def even_better_draw_circles(point, radiusIncrease, number, color, thickness):
